...
<Step title="Optional: Set up Jujutsu (jj)">
  [Jujutsu (jj)](/integrations/jujutsu) is a next-generation version control system that works alongside Git. While optional, it provides advanced features like better branching, conflict resolution, and an intuitive interface. Vibe Kanban will check for jj at startup and show installation instructions if needed.
</Step>
