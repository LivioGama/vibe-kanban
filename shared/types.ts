...
export type Repo = { id: string, path: string, name: string, display_name: string, vcs_backend: string, setup_script: string | null, cleanup_script: string | null, copy_files: string | null, parallel_setup_script: boolean, dev_server_script: string | null, created_at: Date, updated_at: Date, };
...
export type CreateProjectRepo = { display_name: string, git_repo_path: string, vcs_backend: string, };
...
export type RepoWithTargetBranch = { target_branch: string, id: string, path: string, name: string, display_name: string, vcs_backend: string, setup_script: string | null, cleanup_script: string | null, copy_files: string | null, parallel_setup_script: boolean, dev_server_script: string | null, created_at: Date, updated_at: Date, };
...
export type RegisterRepoRequest = { path: string, display_name: string | null, vcs_backend: string, };

export type InitRepoRequest = { parent_path: string, folder_name: string, vcs_backend: string, };
